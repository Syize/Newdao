...
from newdao.CommandDraw import CommandDraw
from newdao.UserHistory import UserHistory
from newdao.WudaoClient import WudaoClient
from newdao.WudaoServer import WudaoServer
from newdao.tools import is_alphabet
...
def newdao():
    ...
    if pid == '':
        if sys.platform == 'linux':
            ...
            print('No server running, please check')
            return
    app = WudaoCommand()
    app.param_parse()
    app.query(app.word)
